...
public class HalamanPembayaran extends JFrame {
    ...
    public HalamanPembayaran(Produk product) {
        ...
        // 3.1. Product Image Panel (Sebelah Kanan)
        ...
        try {
            String imagePath = "img/produk/" + selectedProduct.getImagePath(); 
            ...
            if (imgUrl != null) {
                ...
                imageLabel.setText("<html><div style='width:380px;height:280px;background-color:#ECECEC;text-align:center;line-height:280px;color:black;border:1px solid #DADADA;'>Gambar: " + selectedProduct.getName() +" tidak ditemukan</div></html>"); //
